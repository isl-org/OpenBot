...
public class Constants {
  ...
  public static ArrayList<Category> getCategories() {
    ...
    subCategories = new ArrayList<>();
    subCategories.add(new SubCategory(Constants.PERSON_FOLLOWING, R.drawable.openbot_icon));
    ...
    subCategories.add(new SubCategory(Constants.SMART_VOICE, R.drawable.openbot_icon));
    ...
    subCategories = new ArrayList<>();
    subCategories.add(new SubCategory(Constants.BLOCK_BASED_PROGRAMMING, R.drawable.openbot_icon));
    subCategories.add(new SubCategory(Constants.SCRIPTS, R.drawable.openbot_icon));
    ...
    subCategories = new ArrayList<>();
    subCategories.add(new SubCategory(Constants.SENSORS_FROM_CAR, R.drawable.openbot_icon));
    subCategories.add(new SubCategory(Constants.SENSORS_FROM_PHONE, R.drawable.openbot_icon));
    subCategories.add(new SubCategory(Constants.MAP_VIEW, R.drawable.openbot_icon));
