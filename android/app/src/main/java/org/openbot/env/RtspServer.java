...
class RtspServer implements IVideoServer {
    ...
    public void sendServerUrl() {
        BotToControllerEventBus.emitEvent(Utils.createStatus("VIDEO_SERVER_URL", "rtsp://" + getIPAddress(true) + ":" + PORT + "?trackId=0&h264=200-20-" + WIDTH + "-" + HEIGHT));
    }
    ...
    private void handleControllerEvents() {
        ...
        ControllerToBotEventBus.getProcessor()
                .subscribe(
                        ...
                        error -> {
                            Log.d(TAG, "Error occurred in ControllerToBotEventBus: " + error);
                        });
    }
