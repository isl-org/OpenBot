  ...
  void run() {
    ...
    try {
      BufferedWriter writer =
          new BufferedWriter(new OutputStreamWriter(btSocket.getOutputStream(), StandardCharsets.US_ASCII));
    ...
    try {
      BufferedReader reader =
          new BufferedReader(new InputStreamReader(btSocket.getInputStream(), StandardCharsets.US_ASCII));
      reader.readLine();
    } catch (IOException ex) {
    }
