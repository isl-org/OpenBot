...
def setup_camera():
    PORT = 8046
    return cv2.VideoCapture(f"udpsrc port={PORT} ! application/x-rtp, media=video, encoding-name=H264 ! rtph264depay ! h264parse ! avdec_h264 ! videoconvert ! queue ! appsink", cv2.CAP_GSTREAMER)
