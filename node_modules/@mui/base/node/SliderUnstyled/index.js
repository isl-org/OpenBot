...
var _SliderValueLabelUnstyled2 = require("./SliderValueLabelUnstyled.types");
Object.keys(_SliderValueLabelUnstyled2).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _SliderValueLabelUnstyled2[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _SliderValueLabelUnstyled2[key];
    }
  });
});
