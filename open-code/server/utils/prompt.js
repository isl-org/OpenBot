...
const suggested_blocks_prompt = `After creating the XML, you can suggest various additional blocks that can be added to the playground to enhance the given input.`
