...
Repeat the process of dragging and dropping all necessary code blocks, join them together to form a stack of actions." img = {blocklyCode} width = {18.8} height = {22}/> },
...
Use the OpenBot android application to scan the QR code and successfully save the block code on your device." img = {qrImage}  width = {33} height = {26}/> },
...
Carry out desired actions such as activating indicator lights, detecting objects, and more on your robot car." img = {vehicleImage}  width = {40} height = {26}/> },
];
